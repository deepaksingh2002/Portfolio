...
export const sendMessage = asyncHandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, {}, "Message sent! I'll get back to you soon."));
});
...
export const getMessages = asyncHandler(async (req, res) => {
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        { messages, count: messages.length, unread },
        'Messages fetched'
      )
    );
});
...
export const markRead = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, { message: msg }, 'Message marked as read'));
});
