...
export const getExperience = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, { experience, count: experience.length }, "Experience fetched")
    )
})
...
export const createExperience = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json(new ApiResponse(201, { experience: exp }, "Experience created"))
})
...
export const updateExperience = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, { experience: exp }, "Experience updated"))
})
